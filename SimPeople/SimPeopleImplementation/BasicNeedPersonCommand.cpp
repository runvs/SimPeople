...
namespace SimPeople
{
BasicNeedPersonCommand::BasicNeedPersonCommand(IPersonCommand* pCommandInterface) :  CommandInterfaceDecorator(pCommandInterface)
{
}


BasicNeedPersonCommand::~BasicNeedPersonCommand(void)
{
}

void BasicNeedPersonCommand::SearchAndPerformAction (std::string strAction)
{
